...
class Material {
    public:
        virtual bool Scatter(const Ray& rIn, const RayHit& hit, float3& attenuation, Ray& rOut) const = 0;
};
...
class LambertMat : public Material {
    public:
        ...
        virtual bool Scatter(const Ray& rIn, const RayHit& hit, float3& attenuation, Ray& rOut) const;
        virtual ~LambertMat() {}
    public:
        float3 alb;
};
